...
export const DESCRIPTOR_CASES: DescriptorCase[] = [
  ...
  c('parking', 'PARKMOBILE 770-818-9036 GA', 6.5, 'realtor', 'vehicle_expense', 'ok', { purpose: 'Parking at closing', note: 'business-trip parking is deductible in addition to standard mileage (Pub 463)' }),
  c('ezpass', 'E-ZPASS REBILL', 40, 'rideshare', 'vehicle_expense', 'ok', { purpose: 'Tolls while driving passengers', note: 'tolls on business driving are deductible in addition to standard mileage' }),
  ...
  c('hrblock', 'H&R BLOCK ONLINE 800-472-5625', 189, 'writer', 'other', 'needs_more_info', { purpose: 'Tax prep for my 1040 and Schedule C', note: 'business portion only: business_use_percentage required' }),
