...
export const DESCRIPTOR_CASES: DescriptorCase[] = [
  ...
  c('parking', 'PARKMOBILE 770-818-9036 GA', 6.5, 'realtor', 'vehicle_expense', 'needs_more_info', { purpose: 'Parking at closing' }),
  c('ezpass', 'E-ZPASS REBILL', 40, 'rideshare', 'vehicle_expense', 'needs_more_info', { purpose: 'Tolls while driving passengers' }),
  ...
  c('best-buy-monitor', 'BEST BUY 00012345 SAN FRAN', 349.99, 'designer', 'supplies_small_tools', 'ok', { purpose: 'Second monitor for the design workstation', note: 'under $500: de minimis-eligible supply-like item stays ok' }),
  c('home-depot-desk', 'THE HOME DEPOT #0652', 249, 'writer', 'supplies_small_tools', 'ok', { purpose: 'Standing desk for my writing office' }),
  ...
  c('hiscox', 'HISCOX INC 866-283-7545', 42, 'consultant', 'other', 'ok', { purpose: 'Professional liability insurance for my consulting business' }),
  c('blue-shield', 'BLUE SHIELD OF CA PREMIUM', 486, 'designer', 'other', 'needs_more_info', { purpose: 'My health insurance premium', note: 'Schedule 1 / Form 7206, never Schedule C ok' }),
  ...
  c('legalzoom', 'LEGALZOOM.COM INC', 299, 'photographer', 'other', 'ok', { purpose: 'LLC formation filing for my photography business' }),
  c('hrblock', 'H&R BLOCK ONLINE 800-472-5625', 189, 'writer', 'other', 'needs_more_info', { purpose: 'Tax prep for my 1040 and Schedule C', note: 'business portion only' }),
