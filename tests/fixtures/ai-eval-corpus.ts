...
export const AI_EVAL_CORPUS: EvalCase[] = [
  ...
  {
    id: 'ezpass-rideshare-tolls', title: 'E-ZPass tolls for a rideshare driver ask about app-on trips',
    ...
    expect: { status: 'needs_more_info', transaction_kind: 'expense', category: 'vehicle_expense', missing_field: 'vehicle_method', question_includes: 'app-on' },
    invariants: GATED_EXPENSE,
  },
  {
  ...
  // --- not an expense / Schedule 1: the note cannot turn these into Schedule C deductions ---
  {
    ...
    expect: { status: 'needs_more_info', transaction_kind: 'expense', category: 'other', missing_field: 'transaction_kind', evidence_includes: ['taxes-licenses-sch-c'], question_includes: 'not business expenses', schedule_c_line: null },
    invariants: GATED_EXPENSE,
  },
  {
