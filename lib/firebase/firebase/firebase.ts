...
const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || (() => { if (process.env.NODE_ENV === "production") throw new Error("NEXT_PUBLIC_FIREBASE_API_KEY is required in production"); return ""; })(),
