...
const N = {
  ...
  liability: t('insurance', 'Business liability or E&O premiums are line 15; health premiums go to Schedule 1 (Form 7206), not Schedule C', E.insurance),
  ...
  licenses: t('taxes_licenses', 'License, permit and regulatory renewals are line 23; income and estimated tax payments are never an expense', E.taxes),
...
export const PROFESSION_PRIORS: readonly ProfessionPrior[] = [
  ...
  },
  {
    ...
    typical: [
      ...
      t('taxes_licenses', 'IFTA fuel tax, IRP plates, heavy vehicle use tax (Form 2290), UCR and permits are line 23; loan principal on the truck is not an expense', E.taxes),
  ...
  },
  {
    ...
    typical: [
      ...
      t('taxes_licenses', 'Sales tax collected from buyers and remitted is neither income nor expense; sales tax you owe as the seller is line 23', E.taxes),
  ...
  },
  {
    ...
    typical: [
      ...
      t('repairs_maintenance', 'Repairs that keep tools and equipment working are line 21 (an overhaul or replacement may be a capital improvement); dump and disposal fees are line 27a', E.general.concat(['capital-263'])),
    ],
