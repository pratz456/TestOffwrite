    ...
    <section id="availability" className="py-12 sm:py-16" ref={sectionRef}>
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="animate-on-scroll text-center">
          <span className="mb-3 inline-block rounded-full bg-primary/10 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-primary">What’s included</span>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          ...
          <div className="animate-on-scroll rounded-2xl border border-border bg-muted/30 p-6 sm:p-8">
            ...
            <div className="mt-5 space-y-4 text-sm leading-relaxed text-muted-foreground">
              <p>AI suggests categories and explains what to review. Bank connections are optional. In-app tax filing is not available.</p>
