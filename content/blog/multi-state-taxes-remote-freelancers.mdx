...
Filing thresholds vary widely. Some states exempt small amounts of nonresident income or short stays, while others technically require a return for any state-sourced income. Check the nonresident filing rules for each state where you worked before assuming a short trip is exempt.
