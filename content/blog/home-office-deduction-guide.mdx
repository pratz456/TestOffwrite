...
The simplified method has the same gross-income limitation, but with one important difference: under the actual expense method, disallowed expenses carry forward to a later year (Form 8829, Part IV); under the simplified method, any amount you cannot deduct because of the limit is lost and cannot be carried forward (Rev. Proc. 2013-13, §4.08).
...
*WriteOff asks the Publication 587 questions about your home office and prepares a simplified-method planning worksheet. The regular method on Form 8829 stays with your preparer.*
...
*Simplified method for 2025 and 2026 (not indexed for inflation): $5 per square foot, maximum 300 square feet = $1,500 maximum deduction. Exclusive use test strictly enforced per [IRC § 280A(c)(1)](https://www.law.cornell.edu/uscode/text/26/280A).*
