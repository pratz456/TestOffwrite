...
The word "audit" makes most freelancers nervous, but the fear is often worse than the reality. The IRS audits only about **0.4% of individual returns**, and the vast majority resolve through correspondence (mail), not in-person examination. Most audits are triggered by specific, predictable patterns, and knowing those patterns lets you either avoid them or document your way through them confidently.
...
**Vehicle**: A contemporaneous mileage log with dates, destinations, business purposes, and miles. Odometer readings at year-start and year-end. Records showing the business use percentage matches what you claimed. The 2025 standard mileage rate is 70 cents per mile; for 2026, it's 72.5 cents per mile.
...
1. **Read the notice carefully** and identify exactly what's being questioned. Correspondence audits are narrower than they feel, often targeting a single line item.
