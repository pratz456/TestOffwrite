...
**Social Security (OASDI).** You pay 6.2% of wages and withhold another 6.2% from your employee's pay. Combined rate is 12.4%. This applies only to wages up to the Social Security wage base per employee ($176,100 for 2025; $184,500 for 2026). Wages above that threshold are not subject to Social Security tax.
...
*Social Security wage base: $176,100 for 2025 and $184,500 for 2026. FUTA tax rate: 6.0% on first $7,000 per employee (0.6% after state credit). Additional Medicare Tax: 0.9% withheld on employee wages over $200,000. Sources: [SSA contribution and benefit base](https://www.ssa.gov/oact/cola/cbb.html); [IRS Topic No. 751](https://www.irs.gov/taxtopics/tc751).*
