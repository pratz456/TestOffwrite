...
**Line 10 - Car and truck expenses**: Either the standard mileage rate (72.5 cents per mile for 2026) or actual expenses (gas, insurance, repairs, depreciation). You choose one method per vehicle and generally must stick with it. See **Publication 463** for the details.
