...
**QuickBooks Solopreneur (formerly QuickBooks Self-Employed; paid monthly subscription, pricing varies):** Designed for Schedule C filers. Separates business and personal transactions, tracks mileage, estimates quarterly taxes, connects to TurboTax.
...
*Separate business accounts are not required by the IRS, but every taxpayer must keep records sufficient to establish income and deductions under [IRC § 6001](https://www.law.cornell.edu/uscode/text/26/6001) and [Treas. Reg. § 1.6001-1](https://www.law.cornell.edu/cfr/text/26/1.6001-1); the IRS's [recordkeeping guidance](https://www.irs.gov/businesses/small-businesses-self-employed/recordkeeping) lists bank statements and canceled checks among the supporting documents it expects.*
