...
- AGI after the loss: ($5,500)

That ($5,500) is your potential NOL (the actual NOL is computed on the Publication 536 worksheet, which also removes your standard deduction and any nonbusiness deductions in excess of nonbusiness income). It can be carried forward to offset future profitable years.
...
Before your loss can become an NOL, it must survive the **excess business loss limitation** from Section 461(l). For 2025, non-corporate taxpayers can only deduct up to **$313,000 in business losses** (single filers) or **$626,000** (married filing jointly) against non-business income in a single year; for 2026 the thresholds are **$256,000 / $512,000** (the drop reflects re-based inflation indexing under the One Big Beautiful Bill Act, which also made the limitation permanent).
...
- [IRS Form 461 Instructions](https://www.irs.gov/instructions/i461) - Excess business loss thresholds ($313,000 / $626,000 for 2025; $256,000 / $512,000 for 2026 per Rev. Proc. 2025-32)
