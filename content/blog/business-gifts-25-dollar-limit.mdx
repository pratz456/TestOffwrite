...
As a practical matter, the IRS has indicated that an item worth $100 is too large to be de minimis, so non-cash gifts to employees at or above that level are generally treated as taxable compensation. Cash and gift cards are always taxable wages regardless of amount.
...
The $25 gift limit is mostly a constraint to be aware of, and a reminder that Congress set this number when gas cost about 30 cents a gallon and has shown no interest in updating it.
