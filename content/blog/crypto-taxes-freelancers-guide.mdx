...
More clients are paying in crypto. If you have accepted any, you created tax obligations that most standard guides completely skip. Since IRS Notice 2014-21, the position has been clear: **crypto is property, not currency.** That one classification creates two separate tax events from a single payment.
...
Getting historical prices: Coinbase, Kraken, CoinGecko, and CoinMarketCap all have historical data. For freelancers with significant crypto activity, Koinly, CoinLedger, and CoinTracker automate most of this.
...
**Specific identification:** You choose which units to sell, which lets you optimize for tax treatment (sell high-basis units to minimize gains).
