...
- 1099-NEC forms from direct clients who paid you $600 or more (2025) or $2,000 or more (2026 and later)
...
Your Schedule C gross receipts should capture every dollar clients and platforms were charged on your behalf - including platform fees that were withheld before payout, which you then deduct separately on Line 10. Reporting gross receipts that reconcile to your 1099s avoids IRS matching notices. The sum of all 1099s issued to you will still differ from your bank deposits because:

1. Some clients did not send a form (they paid you less than the reporting threshold)
2. Platform 1099-Ks show gross volume including their fees
3. You may have had returns, refunds, or chargebacks

The solution: build a reconciliation. Start with total business deposits for the year, add income sitting in PayPal/Stripe/platform balances not yet deposited, then add back the platform fees withheld before payout. The result should match or exceed the total of your 1099s; the fees go on Line 10 and refunds on Line 2 so you are never taxed on money you did not keep.
