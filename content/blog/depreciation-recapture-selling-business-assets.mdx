...
What surprises many taxpayers is that recapture also applies if you used the **standard mileage rate**. The IRS treats standard mileage rate users as having claimed "deemed depreciation" on the vehicle. The depreciation component of the standard rate is set each year: **30 cents per mile for 2024, 33 cents for 2025 (out of the 70-cent rate), and 35 cents for 2026** (IRS Notice 2026-10). Even though you never filled out a depreciation schedule, the IRS calculates what your depreciation "would have been" and recaptures it on sale.

If you drove 15,000 business miles in each of 2024, 2025 and 2026, your deemed depreciation is 15,000 x ($0.30 + $0.33 + $0.35), which equals **$14,700**. If you then sell the car for more than its adjusted basis (original cost minus deemed depreciation), the gain up to $14,700 is ordinary income from recapture.
...
**Factor recapture into sale decisions.** Before selling a fully depreciated asset, calculate the tax hit. A $3,000 sale that generates $3,000 of ordinary income could cost you $660 to $1,110 in federal income tax (at 22% to 37% rates). Section 1245 recapture is reported on Form 4797 rather than as Schedule C income, and gains from selling business property are excluded from net earnings from self-employment under IRC §1402(a)(3), so no self-employment tax applies to the recapture itself.
...
*WriteOff keeps a record of the business assets you enter, including cost, business-use percentage and the depreciation method or election you chose, so you and your preparer have the details when it is time to sell.*
...
- [IRS Notice 2026-10](https://www.irs.gov/pub/irs-drop/n-26-10.pdf) - 2026 standard mileage rate and the 35-cent depreciation component (with prior-year components in §4)
- [IRC § 1402(a)(3)](https://www.law.cornell.edu/uscode/text/26/1402) - Gains from selling business property are excluded from net earnings from self-employment
