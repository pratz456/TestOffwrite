          ...
          <CardContent className="p-8 md:p-10 pt-4 space-y-6 [&>div:not(:first-child)]:mt-10 [&>div:not(:first-child)]:border-t [&>div:not(:first-child)]:border-border [&>div:not(:first-child)]:pt-8 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:mb-3 [&_p]:text-sm [&_p]:leading-relaxed [&_li]:text-sm [&_li]:leading-relaxed [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1">
            ...
            <div>
              ...
              <ul>
                ...
                <li>Documents you upload (receipts, W-2s, 1099s) are stored privately for your account. Tax documents are read with software running on our servers; identifying numbers are removed before any text is sent to an AI provider, and an image is sent only if you give the specific consent described in the product.</li>
