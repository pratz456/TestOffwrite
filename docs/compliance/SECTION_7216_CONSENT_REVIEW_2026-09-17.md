...
## 4. Proposed consent text (not wired; for counsel review)
...
| Whole W-2/1099/statement images (with SSNs) sent to OpenAI | Engineering | Mask identifiers before upload; name the disclosure in the consent |
